...
//               <div className="inline-flex items-center gap-3 px-4 py-1 rounded-full bg-yellow-400/10 text-yellow-300 text-sm font-medium border border-yellow-600/20">
//                 <span className="text-sm">Premium Picks</span>
//                 <span className="ml-2 text-xs text-gray-300">Curated by experts</span>
//               </div>

//               <h1 className="text-5xl lg:text-6xl font-serif leading-tight text-white drop-shadow-lg">
//                 Discover the World's Best Restaurants, Hotels & Nightlife
//               </h1>

//               <p className="text-lg lg:text-xl text-gray-300 max-w-xl">
//                 Curated guides & verified listings for dining, stays and nightlife —
//                 luxury-first design, trusted reviews, and local insights to help you
...
//                 <a
//                   href="#explore"
//                   className="inline-block rounded-full bg-linear-to-r from-yellow-400 to-yellow-500 px-6 py-3 font-semibold text-black shadow-xl transform hover:-translate-y-1 transition"
//                 >
//                   Explore Top Places
//                 </a>
//                 <a
//                   href="#search"
//                   className="inline-block rounded-full border border-gray-700 px-6 py-3 text-gray-200 hover:bg-white/5 transition"
//                 >
//                   Search Listings
//                 </a>
//               </div>
...
//                 desc: "Handpicked premium venues and hotels with verified service standards and exclusive recommendations.",
//               },
//               {
//                 title: "Verified Reviews",
//                 desc: "Real reviews, quality checks, and heavy emphasis on guest experience and safety.",
//               },
//               {
//                 title: "Global & Local",
//                 desc: "Deep local knowledge blended with global standards — for travelers and locals alike.",
//               },
//             ].map((card) => (
//               <article
//                 key={card.title}
...
//                 subtitle: "Tasting menus & Michelin-style service",
...
//                 img: "https://images.unsplash.com/photo-1501117716987-c8e9f3f5a0b7?auto=format&fit=crop&w=800&q=60",
//               },
//               {
//                 title: "Cozy Cafes",
...
//               {
//                 title: "Rooftop Bars",
//                 subtitle: "Cocktails with a skyline view",
...
//             <h3 className="text-xl text-white mb-2">Search listings</h3>
...
//               Get admissions, events and curated hospitality updates.
//             </p>
...
//               Explore curated lists and local insights across categories.
//             </p>
//           </div>
